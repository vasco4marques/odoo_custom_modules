...
//#region node_modules/@vscode/iconv-lite-umd/lib/iconv-lite-umd.js
	...
	(function(n, r) {
		...
		return e = {
			...
			82: (e, t, n) => {
				...
				function c(e, t) {
					(e ||= {}).addBOM === void 0 && (e.addBOM = !0), this.encoder = t.iconv.getEncoder("utf-16le", e);
				}
				function l(e, t) {
				...
				function u(e, t) {
					var n = [], r = 0, i = 0, a = 0;
					t: for (var o = 0; o < e.length; o++) for (var s = e[o], c = 0; c < s.length; c++) if (n.push(s[c]), n.length === 2) {
						if (r === 0) {
							if (n[0] === 255 && n[1] === 254) return "utf-16le";
							if (n[0] === 254 && n[1] === 255) return "utf-16be";
						}
						if (n[0] === 0 && n[1] !== 0 && a++, n[0] !== 0 && n[1] === 0 && i++, n.length = 0, ++r >= 100) break t;
					}
					return a > i ? "utf-16be" : a < i ? "utf-16le" : t || "utf-16le";
				}
				t.utf16be = i, i.prototype.encoder = a, i.prototype.decoder = o, i.prototype.bomAware = !0, a.prototype.write = function(e) {
					...
					var t = r.alloc(e.length + 1), n = 0, i = 0;
					for (this.overflowByte !== -1 && (t[0] = e[0], t[1] = this.overflowByte, n = 1, i = 2); n < e.length - 1; n += 2, i += 2) t[i] = e[n + 1], t[i + 1] = e[n];
			...
			141: (e, t, n) => {
				var r = n(861).Buffer, i = r.isEncoding || function(e) {
				...
				function a(e) {
					...
					switch (this.encoding = function(e) {
						...
						if (typeof t != "string" && (r.isEncoding === i || !i(e))) throw Error("Unknown encoding: " + e);
						return t || e;
					}(e), this.encoding) {
						case "utf16le":
				...
				function s(e) {
					...
					return n === void 0 ? this.lastNeed <= e.length ? (e.copy(this.lastChar, t, 0, this.lastNeed), this.lastChar.toString(this.encoding, 0, this.lastTotal)) : (e.copy(this.lastChar, t, 0, e.length), void (this.lastNeed -= e.length)) : n;
				}
				function c(e, t) {
					if ((e.length - t) % 2 == 0) {
				...
				t.I = a, a.prototype.write = function(e) {
					...
					var t, n;
					if (this.lastNeed) {
						if ((t = this.fillLast(e)) === void 0) return "";
					...
					var n = function(e, t, n) {
						...
						if (r < n) return 0;
						var i = o(t[r]);
						return i >= 0 ? (i > 0 && (e.lastNeed = i - 1), i) : --r < n || i === -2 ? 0 : (i = o(t[r])) >= 0 ? (i > 0 && (e.lastNeed = i - 2), i) : --r < n || i === -2 ? 0 : (i = o(t[r])) >= 0 ? (i > 0 && (i === 2 ? i = 0 : e.lastNeed = i - 3), i) : 0;
					}(this, e, t);
			...
			161: (e, t, n) => {
				var r = n(774).Buffer;
				t._dbcs = u;
				for (var i = -1, a = -2, o = -10, s = -1e3, c = Array(256), l = 0; l < 256; l++) c[l] = i;
				function u(e, t) {
					...
					if (typeof e.gb18030 == "function") {
						...
						for (r = 129; r <= 254; r++) for (var d = this.decodeTables[s - u[r]], f = 48; f <= 57; f++) {
							if (d[f] === i) d[f] = s - o;
							else if (d[f] > s) throw Error("gb18030 decode tables conflict at byte 2");
							for (var p = this.decodeTables[s - d[f]], m = 129; m <= 254; m++) {
								if (p[m] === i) p[m] = s - l;
								else {
									if (p[m] === s - l) continue;
									if (p[m] > s) throw Error("gb18030 decode tables conflict at byte 3");
								}
								for (var h = this.decodeTables[s - p[m]], g = 48; g <= 57; g++) h[g] === i && (h[g] = a);
							}
						}
					}
					...
					if (e.encodeSkipVals) for (r = 0; r < e.encodeSkipVals.length; r++) {
						var v = e.encodeSkipVals[r];
						if (typeof v == "number") _[v] = !0;
						else for (f = v.from; f <= v.to; f++) _[f] = !0;
					}
					...
					this.defCharSB = this.encodeTable[0][t.defaultCharSingleByte.charCodeAt(0)], this.defCharSB === i && (this.defCharSB = this.encodeTable[0]["?"]), this.defCharSB === i && (this.defCharSB = 63);
				}
				function d(e, t) {
				...
				u.prototype.encoder = d, u.prototype.decoder = f, u.prototype._getDecodeTrieNode = function(e) {
					for (var t = []; e > 0; e >>>= 8) t.push(255 & e);
					t.length == 0 && t.push(0);
					for (var n = this.decodeTables[0], r = t.length - 1; r > 0; r--) {
						var a = n[t[r]];
						if (a == i) n[t[r]] = s - this.decodeTables.length, this.decodeTables.push(n = c.slice(0));
						else {
							if (!(a <= s)) throw Error("Overwrite byte in " + this.encodingName + ", addr: " + e.toString(16));
							n = this.decodeTables[s - a];
						}
					}
					return n;
					...
					for (var r = 1; r < e.length; r++) {
						...
						if (typeof i == "string") for (var a = 0; a < i.length;) {
							...
							if (s >= 55296 && s < 56320) {
								...
								if (!(c >= 56320 && c < 57344)) throw Error("Incorrect surrogate pair in " + this.encodingName + " at chunk " + e[0]);
								n[t++] = 65536 + 1024 * (s - 55296) + (c - 56320);
							} else if (s > 4080 && s <= 4095) {
								for (var l = 4095 - s + 2, u = [], d = 0; d < l; d++) u.push(i.charCodeAt(a++));
								n[t++] = o - this.decodeTableSeq.length, this.decodeTableSeq.push(u);
							} else n[t++] = s;
						}
						else {
							if (typeof i != "number") throw Error("Incorrect type '" + typeof i + "' given in " + this.encodingName + " at chunk " + e[0]);
							var f = n[t - 1] + 1;
							for (a = 0; a < i; a++) n[t++] = f++;
						}
					}
					...
					var t = e >> 8;
					return this.encodeTable[t] === void 0 && (this.encodeTable[t] = c.slice(0)), this.encodeTable[t];
					...
					var n, r = e[0], a = this._getEncodeBucket(r), s = 255 & r;
					a[s] <= o ? n = this.encodeTableSeq[o - a[s]] : (n = {}, a[s] !== i && (n[-1] = a[s]), a[s] = o - this.encodeTableSeq.length, this.encodeTableSeq.push(n));
					for (var c = 1; c < e.length - 1; c++) {
						var l = n[r];
						typeof l == "object" ? n = l : (n = n[r] = {}, l !== void 0 && (n[-1] = l));
					}
					n[r = e[e.length - 1]] = t;
				}, u.prototype._fillEncodeTable = function(e, t, n) {
					for (var r = this.decodeTables[e], i = !1, a = {}, c = 0; c < 256; c++) {
						var l = r[c], u = t + c;
						if (!n[u]) if (l >= 0) this._setEncodeChar(l, u), i = !0;
						else if (l <= s) {
							var d = s - l;
							if (!a[d]) {
								var f = u << 8 >>> 0;
								this._fillEncodeTable(d, f, n) ? i = !0 : a[d] = !0;
							}
						} else l <= o && (this._setEncodeSequence(this.decodeTableSeq[o - l], u), i = !0);
					}
					return i;
				}, d.prototype.write = function(e) {
					for (var t = r.alloc(e.length * (this.gb18030 ? 4 : 3)), n = this.leadSurrogate, a = this.seqObj, s = -1, c = 0, l = 0;;) {
						if (s === -1) {
							if (c == e.length) break;
						...
						if (u >= 55296 && u < 57344) if (u < 56320) {
							...
							n = u, u = i;
						} else n === -1 ? u = i : (u = 65536 + 1024 * (n - 55296) + (u - 56320), n = -1);
						else n !== -1 && (s = u, u = i, n = -1);
						var d = i;
						if (a !== void 0 && u != i) {
							var f = a[u];
							if (typeof f == "object") {
							...
							typeof f == "number" ? d = f : f == null && (f = a[-1]) !== void 0 && (d = f, s = u), a = void 0;
						} else if (u >= 0) {
							var m = this.encodeTable[u >> 8];
							if (m !== void 0 && (d = m[255 & u]), d <= o) {
								a = this.encodeTableSeq[o - d];
								continue;
							}
							if (d == i && this.gb18030) {
								var h = p(this.gb18030.uChars, u);
								if (h != -1) {
									d = this.gb18030.gbChars[h] + (u - this.gb18030.uChars[h]), t[l++] = 129 + Math.floor(d / 12600), d %= 12600, t[l++] = 48 + Math.floor(d / 1260), d %= 1260, t[l++] = 129 + Math.floor(d / 10), d %= 10, t[l++] = 48 + d;
									continue;
								}
							}
						}
						d === i && (d = this.defaultCharSingleByte), d < 256 ? t[l++] = d : d < 65536 ? (t[l++] = d >> 8, t[l++] = 255 & d) : d < 16777216 ? (t[l++] = d >> 16, t[l++] = d >> 8 & 255, t[l++] = 255 & d) : (t[l++] = d >>> 24, t[l++] = d >>> 16 & 255, t[l++] = d >>> 8 & 255, t[l++] = 255 & d);
					}
					return this.seqObj = a, this.leadSurrogate = n, t.slice(0, l);
				}, d.prototype.end = function() {
					if (this.leadSurrogate !== -1 || this.seqObj !== void 0) {
						var e = r.alloc(10), t = 0;
						if (this.seqObj) {
							var n = this.seqObj[-1];
							n !== void 0 && (n < 256 ? e[t++] = n : (e[t++] = n >> 8, e[t++] = 255 & n)), this.seqObj = void 0;
						}
						return this.leadSurrogate !== -1 && (e[t++] = this.defaultCharSingleByte, this.leadSurrogate = -1), e.slice(0, t);
					}
				}, d.prototype.findIdx = p, f.prototype.write = function(e) {
					for (var t = r.alloc(2 * e.length), n = this.nodeIdx, c = this.prevBytes, l = this.prevBytes.length, u = -this.prevBytes.length, d = 0, f = 0; d < e.length; d++) {
						var m, h = d >= 0 ? e[d] : c[d + l];
						if (!((m = this.decodeTables[n][h]) >= 0)) if (m === i) m = this.defaultCharUnicode.charCodeAt(0), d = u;
						else if (m === a) {
							if (d >= 3) var g = 12600 * (e[d - 3] - 129) + 1260 * (e[d - 2] - 48) + 10 * (e[d - 1] - 129) + (h - 48);
							else g = 12600 * (c[d - 3 + l] - 129) + 1260 * ((d - 2 >= 0 ? e[d - 2] : c[d - 2 + l]) - 48) + 10 * ((d - 1 >= 0 ? e[d - 1] : c[d - 1 + l]) - 129) + (h - 48);
							var _ = p(this.gb18030.gbChars, g);
							m = this.gb18030.uChars[_] + g - this.gb18030.gbChars[_];
						} else {
							if (m <= s) {
								n = s - m;
								continue;
							}
							if (!(m <= o)) throw Error("iconv-lite internal error: invalid decoding table value " + m + " at " + n + "/" + h);
							for (var v = this.decodeTableSeq[o - m], y = 0; y < v.length - 1; y++) m = v[y], t[f++] = 255 & m, t[f++] = m >> 8;
							m = v[v.length - 1];
						}
						if (m >= 65536) {
							var b = 55296 | (m -= 65536) >> 10;
							t[f++] = 255 & b, t[f++] = b >> 8, m = 56320 | 1023 & m;
						}
						t[f++] = 255 & m, t[f++] = m >> 8, n = 0, u = d + 1;
					}
					return this.nodeIdx = n, this.prevBytes = u >= 0 ? Array.prototype.slice.call(e, u) : c.slice(u + l).concat(Array.prototype.slice.call(e)), t.slice(0, f).toString("ucs2");
			...
			209: (e) => {
				var t = Object.hasOwn === void 0 ? Function.call.bind(Object.prototype.hasOwnProperty) : Object.hasOwn;
				e.exports = function(e, n) {
					for (var r in n) t(n, r) && (e[r] = n[r]);
				};
			},
			249: (e, t, n) => {
				var r, i = n(774).Buffer, a = n(557), o = n(209), s = e.exports;
				s.encodings = null, s.defaultCharUnicode = "�", s.defaultCharSingleByte = "?", s.encode = function(e, t, n) {
					e = "" + (e || "");
					var r = s.getEncoder(t, n), a = r.write(e), o = r.end();
					return o && o.length > 0 ? i.concat([a, o]) : a;
				}, s.decode = function(e, t, n) {
					typeof e == "string" && (s.skipDecodeWarning ||= (console.error("Iconv-lite warning: decode()-ing strings is deprecated. Refer to https://github.com/ashtuchkin/iconv-lite/wiki/Use-Buffers-when-decoding"), !0), e = i.from("" + (e || ""), "binary"));
					var r = s.getDecoder(t, n), a = r.write(e), o = r.end();
					return o ? a + o : a;
				...
				}, s.toEncoding = s.encode, s.fromEncoding = s.decode, s._codecDataCache = { __proto__: null }, s.getCodec = function(e) {
					if (!s.encodings) {
						var t = n(336);
						s.encodings = { __proto__: null }, o(s.encodings, t);
					}
					for (var r = s._canonicalizeEncoding(e), i = {};;) {
						var a = s._codecDataCache[r];
						if (a) return a;
						var c = s.encodings[r];
						switch (typeof c) {
							case "string":
							...
							case "object":
								...
								i.encodingName ||= r, r = c.type;
								break;
							case "function": return i.encodingName ||= r, a = new c(i, s), s._codecDataCache[i.encodingName] = a, a;
				...
				r && r.Transform ? s.enableStreamingAPI(r) : s.encodeStream = s.decodeStream = function() {
					throw Error("iconv-lite Streaming API is not enabled. Use iconv.enableStreamingAPI(require('stream')); to enable it.");
				};
			},
			251: (e, t) => {
				t.read = function(e, t, n, r, i) {
					var a, o, s = 8 * i - r - 1, c = (1 << s) - 1, l = c >> 1, u = -7, d = n ? i - 1 : 0, f = n ? -1 : 1, p = e[t + d];
					for (d += f, a = p & (1 << -u) - 1, p >>= -u, u += s; u > 0; a = 256 * a + e[t + d], d += f, u -= 8);
					for (o = a & (1 << -u) - 1, a >>= -u, u += r; u > 0; o = 256 * o + e[t + d], d += f, u -= 8);
					if (a === 0) a = 1 - l;
					else {
						if (a === c) return o ? NaN : Infinity * (p ? -1 : 1);
						o += 2 ** r, a -= l;
					}
					return (p ? -1 : 1) * o * 2 ** (a - r);
				}, t.write = function(e, t, n, r, i, a) {
					var o, s, c, l = 8 * a - i - 1, u = (1 << l) - 1, d = u >> 1, f = i === 23 ? 2 ** -24 - 2 ** -77 : 0, p = r ? 0 : a - 1, m = r ? 1 : -1, h = +(t < 0 || t === 0 && 1 / t < 0);
					for (t = Math.abs(t), isNaN(t) || t === Infinity ? (s = +!!isNaN(t), o = u) : (o = Math.floor(Math.log(t) / Math.LN2), t * (c = 2 ** -o) < 1 && (o--, c *= 2), (t += o + d >= 1 ? f / c : f * 2 ** (1 - d)) * c >= 2 && (o++, c /= 2), o + d >= u ? (s = 0, o = u) : o + d >= 1 ? (s = (t * c - 1) * 2 ** i, o += d) : (s = t * 2 ** (d - 1) * 2 ** i, o = 0)); i >= 8; e[n + p] = 255 & s, p += m, s /= 256, i -= 8);
					for (o = o << i | s, l += i; l > 0; e[n + p] = 255 & o, p += m, o /= 256, l -= 8);
					e[n + p - m] |= 128 * h;
				};
			},
			267: (e) => {
			...
			287: (e, t, n) => {
				let r = n(526), i = n(251), a = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
				...
				function l(e, t, n) {
					if (typeof e == "string") return function(e, t) {
						if (typeof t == "string" && t !== "" || (t = "utf8"), !c.isEncoding(t)) throw TypeError("Unknown encoding: " + t);
						let n = 0 | h(e, t), r = s(n), i = r.write(e, t);
					...
					if (Y(e, ArrayBuffer) || e && Y(e.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (Y(e, SharedArrayBuffer) || e && Y(e.buffer, SharedArrayBuffer))) return p(e, t, n);
					if (typeof e == "number") throw TypeError("The \"value\" argument must not be of type number. Received type number");
					let r = e.valueOf && e.valueOf();
					if (r != null && r !== e) return c.from(r, t, n);
					let i = function(e) {
						if (c.isBuffer(e)) {
							let t = 0 | m(e.length), n = s(t);
							return n.length === 0 || e.copy(n, 0, 0, t), n;
						}
						return e.length === void 0 ? e.type === "Buffer" && Array.isArray(e.data) ? f(e.data) : void 0 : typeof e.length != "number" || X(e.length) ? s(0) : f(e);
					}(e);
					if (i) return i;
					if (typeof Symbol < "u" && Symbol.toPrimitive != null && typeof e[Symbol.toPrimitive] == "function") return c.from(e[Symbol.toPrimitive]("string"), t, n);
				...
				function f(e) {
					let t = e.length < 0 ? 0 : 0 | m(e.length), n = s(t);
				...
				function p(e, t, n) {
					...
					let r;
					return r = t === void 0 && n === void 0 ? new Uint8Array(e) : n === void 0 ? new Uint8Array(e, t) : new Uint8Array(e, t, n), Object.setPrototypeOf(r, c.prototype), r;
				}
				function m(e) {
				...
				function h(e, t) {
					...
					let n = e.length, r = arguments.length > 2 && !0 === arguments[2];
					if (!r && n === 0) return 0;
					let i = !1;
					for (;;) switch (t) {
						case "ascii":
				...
				function g(e, t, n) {
					let r = !1;
					if ((t === void 0 || t < 0) && (t = 0), t > this.length || ((n === void 0 || n > this.length) && (n = this.length), n <= 0) || (n >>>= 0) <= (t >>>= 0)) return "";
					for (e ||= "utf8";;) switch (e) {
						case "hex": return A(this, t, n);
						case "utf8":
						case "utf-8": return E(this, t, n);
						case "ascii": return O(this, t, n);
						case "latin1":
						case "binary": return k(this, t, n);
				...
				function v(e, t, n, r, i) {
					...
					if (typeof n == "string" ? (r = n, n = 0) : n > 2147483647 ? n = 2147483647 : n < -2147483648 && (n = -2147483648), X(n = +n) && (n = i ? 0 : e.length - 1), n < 0 && (n = e.length + n), n >= e.length) {
						if (i) return -1;
						n = e.length - 1;
					} else if (n < 0) {
						if (!i) return -1;
					...
					if (typeof t == "string" && (t = c.from(t, r)), c.isBuffer(t)) return t.length === 0 ? -1 : y(e, t, n, r, i);
					if (typeof t == "number") return t &= 255, typeof Uint8Array.prototype.indexOf == "function" ? i ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n) : y(e, [t], n, r, i);
					throw TypeError("val must be string, number or Buffer");
				}
				function y(e, t, n, r, i) {
					let a, o = 1, s = e.length, c = t.length;
					...
					if (i) {
						let r = -1;
						for (a = n; a < s; a++) if (l(e, a) === l(t, r === -1 ? 0 : a - r)) {
							if (r === -1 && (r = a), a - r + 1 === c) return r * o;
						} else r !== -1 && (a -= a - r), r = -1;
					} else for (n + c > s && (n = s - c), a = n; a >= 0; a--) {
						let n = !0;
						for (let r = 0; r < c; r++) if (l(e, a + r) !== l(t, r)) {
							n = !1;
							break;
						}
						if (n) return a;
						...
						if (i + o <= n) {
							...
							switch (o) {
								case 1:
									...
									break;
								case 2:
									n = e[i + 1], (192 & n) == 128 && (c = (31 & t) << 6 | 63 & n, c > 127 && (a = c));
									break;
								case 3:
									n = e[i + 1], r = e[i + 2], (192 & n) == 128 && (192 & r) == 128 && (c = (15 & t) << 12 | (63 & n) << 6 | 63 & r, c > 2047 && (c < 55296 || c > 57343) && (a = c));
									break;
								case 4: n = e[i + 1], r = e[i + 2], s = e[i + 3], (192 & n) == 128 && (192 & r) == 128 && (192 & s) == 128 && (c = (15 & t) << 18 | (63 & n) << 12 | (63 & r) << 6 | 63 & s, c > 65535 && c < 1114112 && (a = c));
							}
						}
						a === null ? (a = 65533, o = 1) : a > 65535 && (a -= 65536, r.push(a >>> 10 & 1023 | 55296), a = 56320 | 1023 & a), r.push(a), i += o;
					}
					return function(e) {
						let t = e.length;
				...
				t.kMaxLength = o, c.TYPED_ARRAY_SUPPORT = function() {
				...
				}(), c.TYPED_ARRAY_SUPPORT || typeof console > "u" || typeof console.error != "function" || console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support."), Object.defineProperty(c.prototype, "parent", {
					enumerable: !0,
					get: function() {
					...
					return function(e, t, n) {
						return u(e), e <= 0 || t === void 0 ? s(e) : typeof n == "string" ? s(e).fill(t, n) : s(e).fill(t);
					}(e, t, n);
					...
					if (Y(e, Uint8Array) && (e = c.from(e, e.offset, e.byteLength)), Y(t, Uint8Array) && (t = c.from(t, t.offset, t.byteLength)), !c.isBuffer(e) || !c.isBuffer(t)) throw TypeError("The \"buf1\", \"buf2\" arguments must be one of type Buffer or Uint8Array");
					if (e === t) return 0;
					...
					let r = c.allocUnsafe(t), i = 0;
					for (n = 0; n < e.length; ++n) {
						let t = e[n];
						if (Y(t, Uint8Array)) i + t.length > r.length ? (c.isBuffer(t) || (t = c.from(t)), t.copy(r, i)) : Uint8Array.prototype.set.call(r, t, i);
						else {
							if (!c.isBuffer(t)) throw TypeError("\"list\" argument must be an Array of Buffers");
							t.copy(r, i);
						}
						i += t.length;
					}
					...
					let e = this.length;
					return e === 0 ? "" : arguments.length === 0 ? E(this, 0, e) : g.apply(this, arguments);
					...
					let e = "", n = t.INSPECT_MAX_BYTES;
					return e = this.toString("hex", 0, n).replace(/(.{2})/g, "$1 ").trim(), this.length > n && (e += " ... "), "<Buffer " + e + ">";
				}, a && (c.prototype[a] = c.prototype.inspect), c.prototype.compare = function(e, t, n, r, i) {
					if (Y(e, Uint8Array) && (e = c.from(e, e.offset, e.byteLength)), !c.isBuffer(e)) throw TypeError("The \"target\" argument must be one of type Buffer or Uint8Array. Received type " + typeof e);
					...
					if (t >= n) return 1;
					if (this === e) return 0;
					let a = (i >>>= 0) - (r >>>= 0), o = (n >>>= 0) - (t >>>= 0), s = Math.min(a, o), l = this.slice(r, i), u = e.slice(t, n);
					for (let e = 0; e < s; ++e) if (l[e] !== u[e]) {
						a = l[e], o = u[e];
						break;
					}
					return a < o ? -1 : +(o < a);
				...
				c.prototype.slice = function(e, t) {
					let n = this.length;
					(e = ~~e) < 0 ? (e += n) < 0 && (e = 0) : e > n && (e = n), (t = t === void 0 ? n : ~~t) < 0 ? (t += n) < 0 && (t = 0) : t > n && (t = n), t < e && (t = e);
					...
					let r = t + 256 * this[++e] + 65536 * this[++e] + this[++e] * 2 ** 24, i = this[++e] + 256 * this[++e] + 65536 * this[++e] + n * 2 ** 24;
					return BigInt(r) + (BigInt(i) << BigInt(32));
				})), c.prototype.readBigUInt64BE = Q((function(e) {
					U(e >>>= 0, "offset");
					let t = this[e], n = this[e + 7];
					t !== void 0 && n !== void 0 || W(e, this.length - 8);
					let r = t * 2 ** 24 + 65536 * this[++e] + 256 * this[++e] + this[++e], i = this[++e] * 2 ** 24 + 65536 * this[++e] + 256 * this[++e] + n;
					...
					e = +e, t >>>= 0, n >>>= 0, r || N(this, e, t, n, 2 ** (8 * n) - 1, 0);
					let i = 1, a = 0;
					...
					let i = 0, a = 1, o = 0;
					for (this[t] = 255 & e; ++i < n && (a *= 256);) e < 0 && o === 0 && this[t + i - 1] !== 0 && (o = 1), this[t + i] = (e / a | 0) - o & 255;
					return t + n;
					...
					let i = n - 1, a = 1, o = 0;
					for (this[t + i] = 255 & e; --i >= 0 && (a *= 256);) e < 0 && o === 0 && this[t + i + 1] !== 0 && (o = 1), this[t + i] = (e / a | 0) - o & 255;
					return t + n;
					...
					if (typeof e == "string") {
						...
						if (typeof r == "string" && !c.isEncoding(r)) throw TypeError("Unknown encoding: " + r);
						if (e.length === 1) {
					...
					if (n <= t) return this;
					let i;
					if (t >>>= 0, n = n === void 0 ? this.length : n >>> 0, e ||= 0, typeof e == "number") for (i = t; i < n; ++i) this[i] = e;
					else {
						let a = c.isBuffer(e) ? e : c.from(e, r), o = a.length;
				...
				function H(e, t, n, r, i, a) {
					if (e > n || e < t) {
						...
						throw i = a > 3 ? t === 0 || t === BigInt(0) ? `>= 0${r} and < 2${r} ** ${8 * (a + 1)}${r}` : `>= -(2${r} ** ${8 * (a + 1) - 1}${r}) and < 2 ** ${8 * (a + 1) - 1}${r}` : `>= ${t}${r} and <= ${n}${r}`, new z.ERR_OUT_OF_RANGE("value", i, e);
					}
					(function(e, t, n) {
			...
			526: (e, t) => {
				t.byteLength = function(e) {
					...
					var t, n, a = s(e), o = a[0], c = a[1], l = new i(function(e, t, n) {
						return 3 * (t + n) / 4 - n;
					...
					return c === 2 && (t = r[e.charCodeAt(n)] << 2 | r[e.charCodeAt(n + 1)] >> 4, l[u++] = 255 & t), c === 1 && (t = r[e.charCodeAt(n)] << 10 | r[e.charCodeAt(n + 1)] << 4 | r[e.charCodeAt(n + 2)] >> 2, l[u++] = t >> 8 & 255, l[u++] = 255 & t), l;
				}, t.fromByteArray = function(e) {
					for (var t, r = e.length, i = r % 3, a = [], o = 16383, s = 0, l = r - i; s < l; s += o) a.push(c(e, s, s + o > l ? l : s + o));
					return i === 1 ? (t = e[r - 1], a.push(n[t >> 2] + n[t << 4 & 63] + "==")) : i === 2 && (t = (e[r - 2] << 8) + e[r - 1], a.push(n[t >> 10] + n[t >> 4 & 63] + n[t << 2 & 63] + "=")), a.join("");
				};
				for (var n = [], r = [], i = typeof Uint8Array < "u" ? Uint8Array : Array, a = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", o = 0; o < 64; ++o) n[o] = a[o], r[a.charCodeAt(o)] = o;
				function s(e) {
					var t = e.length;
			...
			557: (e, t) => {
				...
				t.PrependBOM = n, n.prototype.write = function(e) {
					...
					return this.pass || !t || (t[0] === "﻿" && (t = t.slice(1), typeof this.options.stripBOM == "function" && this.options.stripBOM()), this.pass = !0), t;
			...
			770: (e, t, n) => {
				...
				t._sbcs = i, i.prototype.encoder = a, i.prototype.decoder = o, a.prototype.write = function(e) {
					...
					for (var t = this.decodeBuf, n = r.alloc(2 * e.length), i = 0, a = 0, o = 0; o < e.length; o++) i = 2 * e[o], n[a = 2 * o] = t[i], n[a + 1] = t[i + 1];
					return n.toString("ucs2");
				}, o.prototype.end = function() {};
			},
			774: (e, t, n) => {
				var r, i = n(287), a = i.Buffer, o = {};
				for (r in i) i.hasOwnProperty(r) && r !== "SlowBuffer" && r !== "Buffer" && (o[r] = i[r]);
				var s = o.Buffer = {};
				for (r in a) a.hasOwnProperty(r) && r !== "allocUnsafe" && r !== "allocUnsafeSlow" && (s[r] = a[r]);
				if (o.Buffer.prototype = a.prototype, s.from && s.from !== Uint8Array.from || (s.from = function(e, t, n) {
					...
					var r = a(e);
					return t && t.length !== 0 ? typeof n == "string" ? r.fill(t, n) : r.fill(t) : r.fill(0), r;
			...
			792: (e, t, n) => {
				...
				e.exports = function(e) {
					var t = e.Transform;
					function n(e, n) {
						this.conv = e, (n ||= {}).decodeStrings = !1, t.call(this, n);
					}
					function i(e, n) {
						this.conv = e, (n ||= {}).encoding = this.encoding = "utf8", t.call(this, n);
					}
					return n.prototype = Object.create(t.prototype, { constructor: { value: n } }), n.prototype._transform = function(e, t, n) {
						...
						if (!(r.isBuffer(e) || e instanceof Uint8Array)) return n(/* @__PURE__ */ Error("Iconv decoding stream needs buffers as its input."));
						try {
			...
			861: (e, t, n) => {
				...
				i.from && i.alloc && i.allocUnsafe && i.allocUnsafeSlow ? e.exports = r : (a(r, t), t.Buffer = o), o.prototype = Object.create(i.prototype), a(i, o), o.from = function(e, t, n) {
					...
					var r = i(e);
					return t === void 0 ? r.fill(0) : typeof n == "string" ? r.fill(t, n) : r.fill(t), r;
			...
			911: (e, t, n) => {
				...
				o.prototype.write = function(e) {
					...
					for (var t = r.alloc(3 * e.length), n = 0, i = 0; i < e.length; i++) {
						...
						a < 128 ? t[n++] = a : a < 2048 ? (t[n++] = 192 + (a >>> 6), t[n++] = 128 + (63 & a)) : (t[n++] = 224 + (a >>> 12), t[n++] = 128 + (a >>> 6 & 63), t[n++] = 128 + (63 & a));
					}
					return t.slice(0, n);
					...
					for (var t = this.acc, n = this.contBytes, r = this.accBytes, i = "", a = 0; a < e.length; a++) {
						var o = e[a];
						(192 & o) == 128 ? n > 0 ? (t = t << 6 | 63 & o, r++, --n === 0 && (i += r === 2 && t < 128 && t > 0 || r === 3 && t < 2048 ? this.defaultCharUnicode : String.fromCharCode(t))) : i += this.defaultCharUnicode : (n > 0 && (i += this.defaultCharUnicode, n = 0), o < 128 ? i += String.fromCharCode(o) : o < 224 ? (t = 31 & o, n = 1, r = 1) : o < 240 ? (t = 15 & o, n = 2, r = 1) : i += this.defaultCharUnicode);
					}
