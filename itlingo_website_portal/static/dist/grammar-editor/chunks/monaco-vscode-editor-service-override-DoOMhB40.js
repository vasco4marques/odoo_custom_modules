...
import { D as x, E as S, T as C, w } from "./fileConstants-BXb76arb.js";
import { c as T } from "./fileCommands._save-Cc8V0c-n.js";
import { i as E, t as D } from "./tools-DMW4ALLH.js";
import { n as O, r as k, t as A } from "./editor-BCJxFvSN.js";
u(), i(), l(), x(), v(), t(), C(), m(), h(), r(), y(), s(), D();
var j = class {
	constructor() {
...
function P(t) {
	return {
		[e.toString()]: new f(S, void 0, !0),
		[g.toString()]: new f(O, [t, () => !1], !0),
		[w.toString()]: new f(T, [], !1),
