...
import { T as Dr, a as Or, c as kr, d as Ar, f as jr, i as Mr, l as Nr, m as Pr, n as Fr, p as Ir, r as Lr, s as Rr, t as zr, w as Br } from "./fileConstants-BXb76arb.js";
...
var Q = ci = class extends fr {
	...
	prefersEditorPane(e) {
		return this.forceOpenAs === Z.Binary ? e.find((e) => e.typeId === Nr) : e.find((e) => e.typeId === Pr);
	}
	resolve(e) {
...
function wi(e) {
	...
	if (n && He(n) && t instanceof ce) {
		let e = A(t.getSelectedElements().filter((e) => e instanceof jr)), n = t.getFocusedElements(), r = n.length ? n[0] : void 0, i;
		return r instanceof jr && (i = r), e.some((e) => e === i) ? e : i ? [i] : void 0;
	}
}
