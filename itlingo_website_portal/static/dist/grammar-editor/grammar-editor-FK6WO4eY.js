...
e && (window.addEventListener("error", o, { capture: !0 }), window.addEventListener("unhandledrejection", o, { capture: !0 }), s() ? import("./chunks/main-DFD7papu.js").then((n) => (t = n.mountGrammarEditor(e), t?.start())).catch((e) => {
